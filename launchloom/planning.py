...
from .models import Brief, Plan, Scene


def make_plan(b: Brief) -> Plan:
    ...
    return Plan(concept=f"{b.audience}に、{b.name}を説明する前に使う場面を見せる。" if ja else f"Show {b.audience} the change {b.name} makes before explaining it.",
        visual_direction="Quiet typography, a warm accent, restrained motion, readable real-product footage. No fabricated screens or performance claims.",
